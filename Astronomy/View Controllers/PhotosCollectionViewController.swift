...
//        guard let sol = solDescription?.sol, sol > 0 else {   //should be index
...
//        }
        ...
        guard let description = solDescription,
            ...
            description.sol > 0 else {   //should be index
            solDescription = solDescriptions.first
            return
        }
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return photoReferences.count   //second this is counted zero
    }
    ...
    private func loadImage(forCell cell: ImageCollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        let completionOp = BlockOperation {
            ...
            if let currentIndexPath = self.collectionView?.indexPath(for: cell),
                currentIndexPath != indexPath {  //third issue point
